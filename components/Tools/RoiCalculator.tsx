              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    value={cogs}
                    onChange={(e) =>
                      setCogs(parseFloat(e.target.value))
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    value={adsCost}
                    onChange={(e) =>
                      setAdsCost(parseFloat(e.target.value))
                    }
                    className="w-full p-2 border rounded focus:ring-2 focus:ring-green-500 outline-none"
                    placeholder="0"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    value={opsCost}
                    onChange={(e) =>
                      setOpsCost(parseFloat(e.target.value))
                    }
                    className="w-full p-2 border rounded focus:ring-2 focus:ring-green-500 outline-none"
                    placeholder="0"
                  />
                ...
                <ul className="space-y-2">
                  {margin < 15 && (
                    <li className="text-red-600 flex gap-2">
                      ...
                      {margin.toFixed(1)}%). Cần giảm COGS hoặc tăng giá
                      bán.
                    </li>
                  )}
                  ...
                  {roas < breakEvenRoas && (
                    <li className="text-red-600 flex gap-2">
                      <ArrowRight size={16} /> Đang lỗ quảng cáo. ROAS
                      hiện tại ({roas.toFixed(2)}) thấp hơn điểm hòa
                      vốn ({breakEvenRoas.toFixed(2)}).
                    </li>
                  )}

                  {adsCost && Number(adsCost) / totalRev > 0.4 && (
                    <li className="text-orange-600 flex gap-2">
                      <ArrowRight size={16} /> Chi phí Marketing chiếm
                      &gt; 40% doanh thu. Khá rủi ro.
                    </li>
                  )}

                  {margin >= 20 && roas > breakEvenRoas && (
                    <li className="text-green-600 flex gap-2">
                      <ArrowRight size={16} /> Mô hình kinh doanh đang
                      khỏe mạnh. Có thể scale ngân sách.
                    </li>
                  )}
                </ul>
              </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left">
              ...
              <tbody>
                {channels.map((ch) => {
                  const chRoas = ch.cost > 0 ? ch.revenue / ch.cost : 0;
                  const cir =
                    ch.revenue > 0
                      ? (ch.cost / ch.revenue) * 100
                      : 0;
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 text-blue-600">
                    {(
                      ...
                      (channels.reduce((s, c) => s + c.cost, 0) || 1)
                    ).toFixed(2)}
                    x
                  </td>
